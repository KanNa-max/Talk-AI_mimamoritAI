...
/* LED Status */
#define LED_RUN PIN_LED0   // LED(プログラム状態)
#define LED_GNSS PIN_LED1  // LED(GNSS電波状態)
#define LED_SND PIN_LED2   // LED(ELTRES状態)
#define LED_ERR PIN_LED3   // LED(エラー状態)
...
void init_gnss(void) {
    ...
    if (ret != ELTRES_BOARD_RESULT_OK) {
        ...
        Serial.println("Success: init_gnss");
    }
}
