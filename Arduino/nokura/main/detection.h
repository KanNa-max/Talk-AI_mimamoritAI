...
#define CAM_CLIP_X_face 104
#define CAM_CLIP_Y_face 64


#define CAM_CLIP_X_ges 0
#define CAM_CLIP_Y_ges 0
...
void drawBox(uint16_t* imgBuf, int CAM_CLIP_X, int CAM_CLIP_Y);
