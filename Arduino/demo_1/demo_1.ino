 ...
 * Set main player to decode stereo mp3. Stream sample rate is set to "auto
 * detect" <br> System directory "/mnt/sd0/BIN" will be searched for MP3 decoder
 * (MP3DEC file) Open "Sound.mp3" file <br> Set master volume to -16.0 dB
 */
void setup() {
    /* Initialize SD */
    while (!theSD.begin()) {
     ...
     * specify "AS_SP_DRV_MODE_1DRIVER" or "AS_SP_DRV_MODE_2DRIVER" or
     * "AS_SP_DRV_MODE_4DRIVER" as an argument.
     */
    ...
    /*
     * Set main player to decode stereo mp3. Stream sample rate is set to "auto
     * detect" Search for MP3 decoder in "/mnt/sd0/BIN" directory
     */
